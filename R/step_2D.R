step_2D <-
function(P_level_2_level_3, P_level_1_level_2_level_3, N,level_1,site.name,pred.site){

P_level_1_level_3_all <- matrix(0,length(P_level_2_level_3),nlevels(level_1))                    
P_level_1_level_3_unnorm <- matrix(0, nlevels(site.name), nlevels(level_1))
...
rownames(P_level_1_level_3) <- as.character(unique(site.name))
...
rownames(P_level_1_level_3_dist) <- as.character(unique(site.name))
